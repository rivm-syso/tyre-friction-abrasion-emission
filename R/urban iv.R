...
## Sector 1 straight 30 km/h

sector_distance = (800 - (180/360*(2*pi*(38.2/2)))-2*32)
sector_velocity_kmh = 40
sector_start_velocity_kmh = 40
...
## sector 4 second straight sector 
sector_distance = 32
sector_velocity_kmh = 40
sector_start_velocity_kmh = 40
sector_end_velocity_kmh = 20
...
## Sector 5 straight sector simulations
IDIADA_accel_distance_sector_5 = f_accel_distance(sector_start_velocity_kmh, sector_velocity_kmh , c_accel)
IDIADA_accel_slip_sector_5 = f_accel_slip(c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel, grip_index_tyre, x_correct_road, mu_max_ref_tyre_wet, optimal_slip)
IDIADA_accel_friction_work_sector_5 = f_accel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel)

IDIADA_decel_distance_sector_5 =f_decel_distance(sector_velocity_kmh, sector_end_velocity_kmh , c_decel)
IDIADA_decel_slip_sector_5 = f_decel_brake_slip(c_decel, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant ,alpha_slope, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_decel_friction_work_sector_5 = f_decel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant , alpha_slope, c_decel, m_rotate, grip_index_tyre, x_correct_road,c_full_brake_ref_tyre_wet)

IDIADA_const_speed_distance_sector_5 = f_const_speed_distance(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel)
IDIADA_const_speed_slip_sector_5 = f_const_speed_slip(m_vehicle, grav_constant, alpha_slope, c_drag, A_vehicle, rho_air, sector_velocity_kmh, v_wind,c_roll, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_const_speed_friction_work_sector_5 = f_const_speed_friction_work(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel, c_drag, A_vehicle, rho_air, v_wind , c_roll, m_vehicle, grav_constant , alpha_slope, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_total_friction_work_sector_5 = sector_5_repeats*(IDIADA_accel_friction_work_sector_5+IDIADA_decel_friction_work_sector_5+IDIADA_const_speed_friction_work_sector_5)

## sector 6 stop to park in sector 

sector_velocity_kmh = 40
sector_start_velocity_kmh = 40
sector_end_velocity_kmh = 0
sector_underground = "dry asphalt"
sector_alpha_slope = 0
alpha_slope = sector_alpha_slope
sector_latitude = 0 
...
sector_accel_g= 1/grav_constant
c_accel= sector_accel_g*grav_constant
sector_distance = f_decel_distance(sector_velocity_kmh, sector_end_velocity_kmh, c_decel)

sector_6_repeats = 1

IDIADA_accel_distance_sector_6 = f_accel_distance(sector_start_velocity_kmh, sector_velocity_kmh , c_accel)
IDIADA_accel_slip_sector_6 = f_accel_slip(c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel, grip_index_tyre, x_correct_road, mu_max_ref_tyre_wet, optimal_slip)
IDIADA_accel_friction_work_sector_6 = f_accel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel)

IDIADA_decel_distance_sector_6 =f_decel_distance(sector_velocity_kmh, sector_end_velocity_kmh , c_decel)
IDIADA_decel_slip_sector_6 = f_decel_brake_slip(c_decel, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant ,alpha_slope, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_decel_friction_work_sector_6 = f_decel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant , alpha_slope, c_decel, m_rotate, grip_index_tyre, x_correct_road,c_full_brake_ref_tyre_wet)

IDIADA_const_speed_distance_sector_6 = f_const_speed_distance(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel)
IDIADA_const_speed_slip_sector_6 = f_const_speed_slip(m_vehicle, grav_constant, alpha_slope, c_drag, A_vehicle, rho_air, sector_velocity_kmh, v_wind,c_roll, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_const_speed_friction_work_sector_6 = f_const_speed_friction_work(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel, c_drag, A_vehicle, rho_air, v_wind , c_roll, m_vehicle, grav_constant , alpha_slope, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_total_friction_work_sector_6 = sector_6_repeats*(IDIADA_accel_friction_work_sector_6+IDIADA_decel_friction_work_sector_6+IDIADA_const_speed_friction_work_sector_6)

## sector 7 accelerate to park out sector 

sector_velocity_kmh = ((2*pi*11.7)/15)*3.6
sector_start_velocity_kmh = 0
sector_end_velocity_kmh = ((2*pi*11.7)/15)*3.6
sector_underground = "dry asphalt"
sector_alpha_slope = 0
alpha_slope = sector_alpha_slope
sector_latitude = 0 
...
sector_accel_g= 1/grav_constant
c_accel= sector_accel_g*grav_constant
sector_distance = f_accel_distance(sector_start_velocity_kmh , sector_velocity_kmh, c_accel)

sector_7_repeats = 1

IDIADA_accel_distance_sector_7 = f_accel_distance(sector_start_velocity_kmh, sector_velocity_kmh , c_accel)
IDIADA_accel_slip_sector_7 = f_accel_slip(c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel, grip_index_tyre, x_correct_road, mu_max_ref_tyre_wet, optimal_slip)
IDIADA_accel_friction_work_sector_7 = f_accel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel)

IDIADA_decel_distance_sector_7 =f_decel_distance(sector_velocity_kmh, sector_end_velocity_kmh , c_decel)
IDIADA_decel_slip_sector_7 = f_decel_brake_slip(c_decel, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant ,alpha_slope, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_decel_friction_work_sector_7 = f_decel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant , alpha_slope, c_decel, m_rotate, grip_index_tyre, x_correct_road,c_full_brake_ref_tyre_wet)

IDIADA_const_speed_distance_sector_7 = f_const_speed_distance(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel)
IDIADA_const_speed_slip_sector_7 = f_const_speed_slip(m_vehicle, grav_constant, alpha_slope, c_drag, A_vehicle, rho_air, sector_velocity_kmh, v_wind,c_roll, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_const_speed_friction_work_sector_7 = f_const_speed_friction_work(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel, c_drag, A_vehicle, rho_air, v_wind , c_roll, m_vehicle, grav_constant , alpha_slope, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_total_friction_work_sector_7 = sector_7_repeats*(IDIADA_accel_friction_work_sector_7+IDIADA_decel_friction_work_sector_7+IDIADA_const_speed_friction_work_sector_7)


## Sector 8 parking cycle 
...
sector_alpha_bank_slope= 0
sector_corner_radius = 11.7/2
sector_corner_angle = 360
sector_underground = "dry asphalt"

sector_8_repeats = 1

IDIADA_corner_distance_sector_8 = f_corner_distance(sector_corner_radius,sector_corner_angle)
IDIADA_corner_lat_slip_sector_8 = f_corner_lat_slip(m_vehicle , sector_velocity_kmh, sector_corner_radius,grav_constant, sector_alpha_bank_slope, grip_index_tyre, x_correct_road, mu_max_ref_tyre_wet, optimal_slip)
IDIADA_corner_lat_friction_work_sector_8 = f_corner_lat_friction_work(sector_corner_radius,sector_corner_angle, m_vehicle , sector_velocity_kmh, grav_constant, sector_alpha_bank_slope, grip_index_tyre, x_correct_road, mu_max_ref_tyre_wet, optimal_slip)

IDIADA_const_speed_distance_sector_8 = f_const_speed_distance(sector_distance = IDIADA_corner_distance_sector_2,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel)
IDIADA_const_speed_slip_sector_8 = f_const_speed_slip(m_vehicle, grav_constant, alpha_slope, c_drag, A_vehicle, rho_air, sector_velocity_kmh, v_wind,c_roll, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_const_speed_friction_work_sector_8 = f_const_speed_friction_work(sector_distance = IDIADA_corner_distance_sector_2,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel, c_drag, A_vehicle, rho_air, v_wind , c_roll, m_vehicle, grav_constant , alpha_slope, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)

IDIADA_total_friction_work_sector_8 = sector_8_repeats*(IDIADA_corner_lat_friction_work_sector_8+IDIADA_const_speed_friction_work_sector_8)
...
IDIADA_accel_distance_sector_9 = f_accel_distance(sector_start_velocity_kmh, sector_velocity_kmh , c_accel)
IDIADA_accel_slip_sector_9 = f_accel_slip(c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel, grip_index_tyre, x_correct_road, mu_max_ref_tyre_wet, optimal_slip)
IDIADA_accel_friction_work_sector_9 = f_accel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air,sector_start_velocity_kmh, sector_velocity_kmh, v_wind, c_roll, m_vehicle, grav_constant, alpha_slope, m_rotate, c_accel)

IDIADA_decel_distance_sector_9 =f_decel_distance(sector_velocity_kmh, sector_end_velocity_kmh , c_decel)
IDIADA_decel_slip_sector_9 = f_decel_brake_slip(c_decel, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant ,alpha_slope, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_decel_friction_work_sector_9 = f_decel_friction_work(optimal_slip, x_slip_long_force, c_drag, A_vehicle, rho_air, sector_velocity_kmh, sector_end_velocity_kmh , v_wind, c_roll, m_vehicle, grav_constant , alpha_slope, c_decel, m_rotate, grip_index_tyre, x_correct_road,c_full_brake_ref_tyre_wet)

IDIADA_const_speed_distance_sector_9 = f_const_speed_distance(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel)
IDIADA_const_speed_slip_sector_9 = f_const_speed_slip(m_vehicle, grav_constant, alpha_slope, c_drag, A_vehicle, rho_air, sector_velocity_kmh, v_wind,c_roll, m_rotate, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_const_speed_friction_work_sector_9 = f_const_speed_friction_work(sector_distance,sector_start_velocity_kmh, sector_velocity_kmh , c_accel, sector_end_velocity_kmh , c_decel, c_drag, A_vehicle, rho_air, v_wind , c_roll, m_vehicle, grav_constant , alpha_slope, grip_index_tyre, x_correct_road, c_full_brake_ref_tyre_wet)
IDIADA_total_friction_work_sector_9 = sector_9_repeats*(IDIADA_accel_friction_work_sector_9+IDIADA_decel_friction_work_sector_9+IDIADA_const_speed_friction_work_sector_9)
...
+ IDIADA_total_friction_work_sector_5++ IDIADA_total_friction_work_sector_6+ IDIADA_total_friction_work_sector_7+ IDIADA_total_friction_work_sector_8+ IDIADA_total_friction_work_sector_9


IDIADA_friction_work_per_m = IDIADA_total_friction_work/800
