...
rf <- randomForest(wear~ centrW_g_1+decelW_g_1+accelW_g_1+ownWind_Ac_1, data = DFin)
rf <- randomForest(wear~ centrW_g_1+decelW_g_1+accelW_g_1+ownWind_Ac_1+distance+TrackType, data = DFin)
rf <- randomForest(wear~ centrW_g_1+decelW_g_1+accelW_g_1+ownWind_Ac_1+distance+TrackType+mainSpeed, data = DFin)
rf <- randomForest(wear~ centrW_g_1+decelW_g_1+accelW_g_1+ownWind_Ac_1+distance+TrackType+mainSpeed+Tyre, data = DFin)
