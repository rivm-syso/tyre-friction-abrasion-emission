...
#' @param accel_force_end_maneuver_1 Acceleration force at the end of the maneuver (N)
...
f_acc_dry <- function(sector_velocity_ms,
  ...
  ## Longitudinal friction work during acceleration
  ...
  # average velocity of the sector
