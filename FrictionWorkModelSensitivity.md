...
## 1. Data prepartion
    ...
    ## Joining with `by = join_by(Track)`
    ## Joining with `by = join_by(`Test section`, Track, `Sector number`)`
...
## 4. Total Friction Work
    ...
    ## `summarise()` has grouped output by 'RUNS', 'Sector name'. You can override
    ...
    ## `summarise()` has grouped output by 'RUNS'. You can override using the
    ## `.groups` argument.
...
## 5. Global Sensitivity Analysis
    ...
    ## Warning: package 'sensitivity' was built under R version 4.3.2
    ...
    ## Warning: package 'ks' was built under R version 4.3.2
    ...
    ## Adding missing grouping variables: `RUNS`

    ## Joining with `by = join_by(RUNS)`
