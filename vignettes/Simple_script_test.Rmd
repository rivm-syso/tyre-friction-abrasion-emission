...
Data file can be found here: <https://rivmnl.sharepoint.com/:x:/s/LEON-Tyres/ESkEWYF41aBHrJvaIbGf-p4Bb2XIa517LdjYqcBmUrY7_A?e=iNtXcS>
...
AllData2 <-
  AllData |> mutate(RolCoef_min =  fRolCoef_Tlabel(Label_fuelleff = 
                                        ...
                                        Tyre_Label_table = 
                                          readxl::read_excel(
                                            ...
                                            skip=1))$min,
                    RolCoef_max = fRolCoef_Tlabel(Label_fuelleff = 
                                          `Fuel efficiency class`,
                                        vehicle_class = Vehicle_class,
                                        Tyre_Label_table = 
                                          readxl::read_excel(
...
AllData2 |> full_join() |> runif(n.Runs)



AllData2$RolCoef_min  
#TODO: selection based on track, maneuver code, tyre and verhicle
