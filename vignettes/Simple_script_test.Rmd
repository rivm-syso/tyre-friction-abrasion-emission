...
test_accel_long_slip <- 
  f_accel_long_slip(c_roll = c_roll_uniform, 
                    ...
                    grip_index_tyre = grip_index_tyre_unform, 
...
(c_decel, m_vehicle, m_rotate, c_roll, grav_constant, 
                               rho_air, v_start_decel, v_end_decel, v_wind, 
                               alpha_slope, c_max_brake)
...
test_decel_long_slip <- 
  f_decel_long_slip(c_roll = c_roll_uniform, 
                    ...
                    c_max_brake = ) # for wet to dry asphalt
